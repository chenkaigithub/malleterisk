...
public class ClassificationPredictor extends Predictor {
	...
	/** 
	 * @param dimensions - the total number of features.
	 */
	...
	/** Increases the size of the predictor's weights
	 *  to make the predictor ready for training with 
	 *  additional features.
	 */
