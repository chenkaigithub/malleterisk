...
public class LinearClassifier extends Classifier implements Serializable {
	...
	public void createPhiAlphabet(InstanceList trainingSet) {
		...
		if(predictor==null) predictor = new ClassificationPredictor(phiAlphabet.size()); 
	}
	 ...
	 * 
	 * @param tagAlphabet - the expanded labelAlphabet
	 * @param trainingSet - the new training set
	 */
	public void grow(Alphabet tagAlphabet, InstanceList trainingSet) {
		if(this.tagAlphabet != tagAlphabet) throw new IllegalArgumentException("Cannot use a different tagAlphabet!");
