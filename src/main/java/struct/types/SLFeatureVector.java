...
public class SLFeatureVector implements Comparable {
	...
	/** Adds itself to another SLFeatureVector
	 * if the other feature is valid.
	 */
	...
	/** Takes the new parameters and becomes the
	 * head of the chain.
	 */
	...
	/** Creates and returns the distance vector(fv1 - fv2)
	 * of both the SLFeatureVectors.
	 */
	...
	/** Computes the dot product of both the
	 * SLFeatureVectors.
	 */
	...
	/** Normalizes the SLFeatureVector with its
	 * second norm.
	 */
	...
	/** Normalizes the SLFeatureVector with the 
	 * given norm.
	 */
	...
	/** Computes the dot product of this SLFeatureVector
