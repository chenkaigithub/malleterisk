...
public class HandWritInstance extends SequenceInstance {
	...
	/*
	 *  (non-Javadoc)
	 * @see struct.sequence.SequenceInstance#getFeatures(java.io.ObjectInputStream)
	 */
	public SequenceFeatures getFeatures(ObjectInputStream in) throws IOException {
		
		String[] toks = input.sentence;
		
		SLFeatureVector fvs_ij[][][] = 
			new SLFeatureVector[toks.length][tagAlphabet.size()][tagAlphabet.size()];
