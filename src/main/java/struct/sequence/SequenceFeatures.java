...
public class SequenceFeatures implements Features {
	...
	private SLFeatureVector[][][] fvs_ij;
	private SLFeatureVector[][] fvs_j;
	
	/**
	 * 
	 * @param fvs_ij Features for position-label-label
	 * @param fvs_j Features for position-label
	 */
	public SequenceFeatures(SLFeatureVector[][][] fvs_ij,
			SLFeatureVector[][] fvs_j) {
		this.fvs_ij = fvs_ij;
		this.fvs_j = fvs_j;
	}
	 ...
	 * @param y1 Index of first label
	 * @param y2 Index of second label
	 */
