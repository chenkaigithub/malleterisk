...
public class SequenceAccuracyEvaluator implements SLEvaluator {
	 ...
	 * @throws IOException
	 */
	public void evaluate(SLInstance[] data, Predictor predictor, String featureFile, String outFile) throws IOException {
		...
		for(int k = 0; k < data.length; k++) {
			...
			for(int j = 0; j < nP; j++) {
				...
				SequenceLabel sl = (SequenceLabel)prediction.getLabelByRank(j);
				if(sl == null) break;
				nT = 0;
