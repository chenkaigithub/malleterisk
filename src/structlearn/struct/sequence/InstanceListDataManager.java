...
public class InstanceListDataManager extends SequenceDataManager {
	...
	/**
	 * @param iList The Mallet InstanceList
	 */
	...
	/** Creates alphabets.
	 * 
	 * @param createUnsupported whether to add unsupported features.
     *        This means whether to create a feature for some label
     *        if we have only ever seen it with another label.
     *        Adding these to the alphabet allows us to learn a
     *        weight for them. 
     *        Adding unsupported features has been shown to help
     *        with CRF training.
	 * @throws IOException
	 */
	...
	/** Reads instances from a Mallet InstanceList and
	 * converts them into SequenceInstances.
	  * @throws IOException
	 */
