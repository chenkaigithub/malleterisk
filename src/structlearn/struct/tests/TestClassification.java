...
public class TestClassification extends TestCase {
	...
	public void testRandomTrained () {
		...
		System.out.println (classifier.getClass().getName()
				+ ": " + new Trial (classifier, lists[0]).getAccuracy());
		
		System.out.println ("Accuracy on testing set:");
		System.out.println (classifier.getClass().getName()
				+ ": " + new Trial (classifier, lists[1]).getAccuracy());
	}
	...
	public void testNewFeatures () {
	    ...
	    RandomTokenSequenceIterator iter = new RandomTokenSequenceIterator (
...
//	      System.out.println ("DATA:"+inst.getData());
	   // }
	    ...
	    System.out.println ("Accuracy on testing set:");
	    System.out.println (classifier.getClass().getName()
	                          + ": " + new Trial (classifier, testing).getAccuracy());
	  }
